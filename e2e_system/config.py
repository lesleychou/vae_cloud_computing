...
class Config():
    ...
    def __init__(self):
        ...
        self.input_data_path = "data/toy_data/toy_syn_data.csv"

        self.output_processed_data_save_dir = "data/all_data/vae_data_processed/"
        self.output_processed_data_path = os.path.join(self.output_processed_data_save_dir, 'toy_syn_data.csv')

        self.syn_data_save_dir = "syn_data/"
        self.syn_data_path = os.path.join(self.syn_data_save_dir, 'toy_syn_data.csv')
